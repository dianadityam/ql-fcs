<template>
  <LayoutMain>
    <div class="p-5">
      <div>
        <p class="text-lg font-medium mb-3">Form Item Benang</p>
      </div>
      <div class="p-5 bg-white rounded border-t-4 border-primary">
        ...
        <div class="grid grid-cols-6 gap-3 gap-x-20">
          <div
            ...
            :key="index"
            class="col-span-3 grid grid-cols-7"
          >
            <p class="col-span-2 font-medium py-1">{{ item.label }}</p>
            <FormControl
              v-if="item.type == 'text'"
              :type="item.type"
            ...
            <div v-if="item.type == 'file'" class="col-span-5 relative">
              <input
                ...
                type="file"
                class="border p-1.5 text-xs w-full rounded focus:ring-2"
              />
              <div
