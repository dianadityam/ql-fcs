<template>
  <LayoutMain>
    <div class="p-5">
      <div>
        <p class="text-lg font-medium mb-3">Form Item Kain Woven</p>
      </div>
        ...
        <div class="grid grid-cols-6 gap-3 gap-x-20">
          ...
          >
            ...
            <div
              ...
              class="col-span-5 flex items-center gap-3"
            >
              <div
...
const form = ref([
  ...
  //       {
  //         id: 1,
  //         value: "A. Lusi (Vertical)",
  //       },
  //       {
  //         id: 2,
  //         value: "B. Pakan (Horizontal)",
  //       },
  //     ],
  //   },
  {
